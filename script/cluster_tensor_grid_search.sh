...
DATE=$(date +"%Y%m%d")
OUTPUT_PATH="${OUTPUT_DATA_DIR}/${DATE}_${METHOD}_2014_January_top_53_store_2000_item_growth_rate_clustered.csv"
...
LOG_FILE="${LOG_DIR}/${TIMESTAMP}_cluster_tensor_grid_search.log"
LOG_LEVEL="INFO"
