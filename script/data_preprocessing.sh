...
#OUTPUT_FN="${OUTPUT_DATA_DIR}/train_2014_January_12_store_20_item.parquet"
...
# ITEM_FN="${OUTPUT_DATA_DIR}/train_2014_January_12_store_20_item.csv"
# STORE_FN="${OUTPUT_DATA_DIR}/train_2014_January_12_store_20_item_stores.csv"
