...
#MODELS="TFT"
MODELS="EXPONENTIAL_SMOOTHING,AUTO_ARIMA,THETA,KALMAN,LIGHTGBM,RANDOM_FOREST,LINEAR_REGRESSION"
...
if [[ -z "$METRICS_FN" ]]; then
  METRICS_FN="${METRICS_DIR}/${DATE}_2013_2014_store_2000_item_cyc_features_ml_no_covs_metrics.csv"
fi
