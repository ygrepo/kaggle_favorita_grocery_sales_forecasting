...
DATA_FN="${DATA_DIR}/20250711_train_top_300_item_sales_cluster.csv"
#DATA_FN="${DATA_DIR}/20250707_500_train_top_51_store_9000_item_cluster.csv"
OUTPUT_FN="${DATA_DIR}/20250711_train_top_300_item_clusters_sales_cyclical_features_1_days_X_y.csv"
SALES_FN="${DATA_DIR}/20250711_train_top_300_item_sales_cluster.csv"
# OUTPUT_FN="${DATA_DIR}/20250711_train_top_51_store_100_item_clusters_sales_cyclical_features_1_days_X_y.csv"
# SALES_FN="${DATA_DIR}/20250711_sales.csv"
#CYC_FN="${DATA_DIR}/20250711_cyc.csv"
CYC_FN="${DATA_DIR}/20250711_train_top_300_item_cyc_cluster.csv"
