...
DATA_FN="${DATA_DIR}/20250627_train_top_store_500_item.csv"
CLUSTER_FN="${DATA_DIR}/20250629_cluster_df.csv"
OUTPUT_FN="${DATA_DIR}/20250629_train_store_500_item_sales_cyclical_features_16_days_X_y.csv"
DEBUG=true
DEBUG_CYC_FN="${DATA_DIR}/20250629_cyc_debug.csv"
DEBUG_SALES_FN="${DATA_DIR}/20250629_sales_debug.csv"
