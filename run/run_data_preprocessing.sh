...
OUTPUT_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_15_item.csv"
...
END_DATE="2015-12-31"
ITEM_FN="${OUTPUT_DATA_DIR}/20250711_train_top_15_items.csv"
STORE_FN="${OUTPUT_DATA_DIR}/20250711_train_top_15_items_stores.csv"
