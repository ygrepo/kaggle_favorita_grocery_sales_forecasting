...
OUTPUT_FN="${OUTPUT_DATA_DIR}/train_2014_January_10_store_10_item.parquet"
...
#END_DATE="2015-12-31"
END_DATE="2014-01-01"
ITEM_FN="${OUTPUT_DATA_DIR}/train_2014_January_28_store_10_item.csv"
STORE_FN="${OUTPUT_DATA_DIR}/train_2014_January_28_store_10_item_stores.csv"
