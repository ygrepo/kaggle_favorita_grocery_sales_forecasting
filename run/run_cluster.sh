...
STORE_ITEM_MATRIX_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_2000_item_matrix.csv"
CLUSTER_OUTPUT_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_2000_item_cluster_result.csv"
