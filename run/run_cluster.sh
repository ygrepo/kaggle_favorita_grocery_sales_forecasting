...
DATA_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_3000_item_cluster.csv"
...
STORE_ITEM_MATRIX_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_3000_item_matrix.csv"
CLUSTER_OUTPUT_FN="${OUTPUT_DATA_DIR}/20250711_train_top_store_3000_item_cluster_result.csv"
